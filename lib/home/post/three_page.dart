...
class DisplayThreeContent extends StatefulWidget {
  @override
  _DisplayThreeContentState createState() => _DisplayThreeContentState();
}

class _DisplayThreeContentState extends State<DisplayThreeContent> {

  List imageList=[
    "assets/minion.jpg","assets/minion.jpg","assets/minion.jpg",
  ];
  @override
                ...
                children: <Widget>[
                  Expanded(
                    ...
                    child: Container(
                      ...
                      child: Image.asset('assets/minion.jpg',fit: BoxFit.cover,),
                    ),
                  ),
                  Expanded(
                    flex: 1,
