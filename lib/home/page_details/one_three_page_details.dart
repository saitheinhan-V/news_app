...
class OneThreePageDetails extends StatefulWidget {
  final List image;
  OneThreePageDetails({Key key,this.image}):super(key: key);

  @override
  _OneThreePageDetailsState createState() => _OneThreePageDetailsState();
}

class _OneThreePageDetailsState extends State<OneThreePageDetails> {
  ...
  Widget _imageContent(imageList) {
    return Container(
      height: 200.0,
      width: MediaQuery.of(context).size.width,
